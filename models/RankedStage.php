...
/**
 * This is the model class for table "ranked_stage".
 *
 * @property integer $schedule_id
 * @property integer $stage_id
 *
 * @property Stage $stage
 * @property Ranked $schedule
 */
class RankedStage extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['schedule_id'], 'exist', 'skipOnError' => true, 'targetClass' => Ranked::className(), 'targetAttribute' => ['schedule_id' => 'id']],
        ];
    }
    ...
    {
        return $this->hasOne(Ranked::className(), ['id' => 'schedule_id']);
    }
}
